...
- 原始数据与判定见 `../debug/xhttp-native-pipe-no-go.md`。
...
- `../tests/xhttp_stream_tiny_chunks.test.mjs`
- `../tests/xhttp_first_packet_fragmentation.test.mjs`
